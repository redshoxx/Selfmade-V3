...
ok(index.includes('/v32-bookings.css?v=4.4.0-r20'),'Buchungs-CSS wird nicht geladen')
ok(index.includes('/v32-bookings.js?v=4.4.0-r20'),'Buchungs-JS wird nicht geladen')
ok(index.indexOf('/v32-bookings.js')>index.indexOf('/app-v3.js'),'Buchungsmodul muss nach app-v3 geladen werden')
ok(sw.includes('/v32-bookings.js?v=4.4.0-r20')&&sw.includes('/v32-bookings.css?v=4.4.0-r20'),'Buchungs-Assets fehlen im Service Worker')
