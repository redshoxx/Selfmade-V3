...
test('version 14 core assets force a fresh PWA cache', () => {
  assert.match(index, /styles\.css\?v=14/);
  assert.match(index, /app\.js\?v=14/);
  assert.match(sw, /selfmade-v14-native-iphone/);
  assert.match(sw, /version:\s*14/);
});
