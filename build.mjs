...
window.__selfmadeStartError = function(message){
  ...
  if(!root) return;
  root.innerHTML='<main class="onboarding"><div class="mark">!</div><div><span class="eyebrow">STARTFEHLER</span><h1>Selfmade konnte nicht starten.</h1><p>'+String(message||'Ein unerwarteter Fehler ist aufgetreten.')+'</p></div><button class="btn primary" onclick="location.reload()">Erneut versuchen</button><small>Version 3.2.1</small></main>';
};
...
const required = [
  'selfmade-version" content="3.2.1"','mobile-web-app-capable" content="yes"','window.__SELFMADE_READY__=true','__selfmadeStartError','Erneut versuchen','data-app-ready','id="app"','id="sheet"',
...
console.log(`Selfmade V${VERSION}: Cozy-Einkauf mit Swipe-Aktionen und bereinigtem PWA-Head erfolgreich geprüft.`)
