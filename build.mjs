...
const active=['index.html','v3.css','v3-shopping.css','v301-shopping.css','tasks-v3.1.css','v3-dialogs.css','boot-v2.0.2.js','v202-core-safe.js','shopping-core-v3.js','tasks-core-v3.1-fixed.js','tasks-v3.1.js','v202-wallet-guard.js','import-v2.0.2.js','app-v3.js','settings-v3.js','v301-shopping.js','manifest.webmanifest','sw.js','icon.svg']
...
for(const test of ['tests.mjs','import-tests.cjs','v2-tests.cjs','v202-tests.cjs','v3-tests.cjs','v301-v31-tests.cjs','tasks-v3.1-fixed-tests.cjs']){const r=spawnSync(process.execPath,[test],{encoding:'utf8'});if(r.status!==0)throw new Error(`${test}: ${r.stderr||r.stdout}`);console.log(r.stdout.trim())}
const sources=['index.html','v3.css','v3-shopping.css','v301-shopping.css','tasks-v3.1.css','v3-dialogs.css','boot-v2.0.2.js','v202-core-safe.js','shopping-core-v3.js','tasks-core-v3.1-fixed.js','tasks-v3.1.js','v202-wallet-guard.js','import-v2.0.2.js','app-v3.js','settings-v3.js','v301-shopping.js','manifest.webmanifest','sw.js','vercel.json','api/import-transaction.js','api/product-lookup.js']
...
console.log('NEST V3.1.0: Aufgaben, Datumsvalidierung, Erinnerungen bei aktiver PWA, Wiederholungen, Verknüpfungen, Swipe-Gesten, Long-Press-Reorder, Einkauf, Scanner, Backup und Persistenz geprüft.')
