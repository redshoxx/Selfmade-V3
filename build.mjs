...
window.__selfmadeStartError = function(message){
  ...
  if(!root) return;
  root.innerHTML='<main class="onboarding"><div class="mark">!</div><div><span class="eyebrow">STARTFEHLER</span><h1>Selfmade konnte nicht starten.</h1><p>'+String(message||'Ein unerwarteter Fehler ist aufgetreten.')+'</p></div><button class="btn primary" onclick="location.reload()">Erneut versuchen</button><small>Version 3.0.0</small></main>';
};
...
const required = [
  'selfmade-version" content="3.0.0"','window.__SELFMADE_READY__=true','__selfmadeStartError','Erneut versuchen','data-app-ready','id="app"','id="sheet"',
