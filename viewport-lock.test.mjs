...
test('version 13 core assets force a fresh PWA cache', () => {
  assert.match(index, /styles\.css\?v=13/);
  assert.match(index, /app\.js\?v=13/);
  assert.match(sw, /selfmade-v13-zoom-lock/);
  assert.match(sw, /version:\s*13/);
});
