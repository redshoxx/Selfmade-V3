...
ok(index.includes('/v322-nav.js?v=4.4.0-r22'),'V4.4 Navigation wird nicht geladen')
ok(index.indexOf('/v322-nav.js')>index.indexOf('/v32-bookings.js'),'Navigation muss nach Buchungsmodul geladen werden')
ok(sw.includes('/v322-nav.js?v=4.4.0-r22'),'V4.4 Navigation fehlt im Service Worker')
