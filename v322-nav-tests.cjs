...
ok(nav.includes("RELEASE='4.2.0'"),'V4.2 Navigationsmodul fehlt')
...
ok(index.includes('/v322-nav.js?v=4.2.0-r16'),'V4.2 Navigation wird nicht geladen')
ok(index.indexOf('/v322-nav.js')>index.indexOf('/v32-bookings.js'),'Navigation muss nach Buchungsmodul geladen werden')
ok(sw.includes('/v322-nav.js?v=4.2.0-r16'),'V4.2 Navigation fehlt im Service Worker')
ok(build.includes("'v322-nav.js'"),'Navigation fehlt im Build')
console.log('NEST V4.2 navigation tests passed')
