...
ok(nav.includes('/v4-lidl.js?v=4.0.0-r14')&&nav.includes('/v4-lidl.css?v=4.0.0-r14'),'V4 Lidl Loader fehlt')
ok(index.includes('/v322-nav.js?v=3.2.2-r13'),'Navigation wird nicht geladen')
