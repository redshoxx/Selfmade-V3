const CACHE='nest-v2.1.0-savings'
const SHELL=['/index.html','/styles.css?v=2.1.0','/nav.css?v=2.1.0','/settings-v1.3.css?v=2.1.0','/v2.css?v=2.1.0','/v2-nav-center.css?v=2.1.0','/v202.css?v=2.1.0','/challenges-v2.0.2.css?v=2.1.0','/savings-v2.1.css?v=2.1.0','/boot-v2.0.2.js?v=2.1.0','/v202-core-safe.js?v=2.1.0','/v202-wallet-guard.js?v=2.1.0','/import-v2.0.2.js?v=2.1.0','/challenges-v2.0.2.js?v=2.1.0','/app-v2.0.2.js?v=2.1.0','/savings-v2.1.js?v=2.1.0','/settings-v2.0.2.js?v=2.1.0','/manifest.webmanifest','/icon.svg']
