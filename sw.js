const CACHE='nest-v2.0.0-web-audit-nav2'
const SHELL=['/index.html','/styles.css?v=2.0.0','/nav.css?v=2.0.0','/settings-v1.3.css?v=2.0.0','/v2.css?v=2.0.0','/v2-nav-center.css?v=2.0.0-nav2','/v2-core.js?v=2.0.0','/import.js?v=2.0.0','/app.js?v=2.0.0','/settings-v1.3.js?v=2.0.0','/v2-ui.js?v=2.0.0','/v2-nav-center.js?v=2.0.0-nav2','/manifest.webmanifest','/icon.svg']
