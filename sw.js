const CACHE='nest-v1.3.0-settings-v1'
const SHELL=['/index.html','/styles.css?v=1.2.0','/nav.css?v=premium-nav-v1','/settings-v1.3.css?v=1.3.0','/import.js?v=wallet-import-v1','/app.js?v=1.2.0','/settings-v1.3.js?v=1.3.0','/manifest.webmanifest','/icon.svg']
