...
assert.ok(index.includes('/native-v44.js?v=4.4.0-r21'),'Native Bridge wird nicht geladen')
assert.ok(index.indexOf('/native-v44.js')<index.indexOf('/app-v3.js'),'Native Bridge muss vor App-Code laden')
assert.ok(sw.includes("nest-v4.4.0-r21")&&sw.includes('/native-v44.js?v=4.4.0-r21'),'Native Bridge fehlt im PWA-Cache')
...
console.log('NEST V4.4.0 iOS Capacitor, unique embedded bundle IDs and Sideloadly IPA regression tests passed')
